...
Структура папок и файлов объявлений полностью аналогична структуре папок и файлов событий приходской жизни с той лишь разницей, что дата в объявлениях играет роль дня окончания действия объявления (включительно).
