...
- `my-image-mobile.webp` - файл для размера экрана `mobile` с физическими размерами по ширине `1134px`;
- `my-image-tablet.webp` - файл для размера экрана `tablet` с физическими размерами по ширине `1188px`;
- `my-image-laptop.webp` - файл для размера экрана `laptop` с физическими размерами по ширине `1852px`;
- `my-image-desktop.webp` - файл для размера экрана `desktop` с физическими размерами по ширине `2222px`.
