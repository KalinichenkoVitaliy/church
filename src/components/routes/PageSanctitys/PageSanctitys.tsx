...
export function PageSanctitys() {
  ...
  return (
    <div className={styles.pageSanctitys}>
      ...
      <BreakAfterH2 />
      <TextIndentP>В Свято-Никольском храме станицы Фастовецкой имеются следующие иконы с частицами мощей:</TextIndentP>
      <BreakInterP />
      <BreakInterP />
      <TextP>
        <PictureOncePhoto
      ...
      <TextP>
        ...
        />
        - преподобной Марфы Дивеевской, преподобной Александры Первоначальницы Дивеевской, привезённые из паломнической
        поездки в Дивеевский монастырь в 2004 году;
      </TextP>
      <BreakInterP />
      <BreakInterP />
      <TextP>
      ...
      <BreakInterP />
      <TextP>
        <PictureOncePhoto name='images/photos/sanctitys/stTatiana' alt='Фото иконы святой мученицы Татианы' />- частица
        мощей десницы святой мученицы Татианы была подарена нашему храму в 2002 году, а в 2003 году была написана икона
        мученицы;
      </TextP>
      <BreakInterP />
      <BreakInterP />
