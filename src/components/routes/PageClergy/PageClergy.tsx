...
export function PageClergy() {
  ...
  return (
    <div className={styles.pageClergy}>
      ...
      >
        <Picture
          name='images/clergy/pater-valeriy'
      ...
      >
        ...
        Фастовецкой. 17 марта 1999 года родилась дочь Мария Бочарникова, 12 декабря 2002 года родился сын Бочарников
        Николай. С 2003 года нёс послушание помощника благочинного по образованию и катехизации. С 30 мая 2014 года и по
        25 декабря 2017 года исполнял обязанности благочинного Тихорецкого церковного округа.
      </Text>
      <Break stepMobile={8} stepTablet={10} stepLaptop={14} stepDesktop={18} top />
      <Text
        As='p'
      ...
      >
        <Picture
          name='images/clergy/pater-aleksandr'
