...
export function PageSchedule() {
  ...
  return (
    <div className={styles.pageSchedule}>
      ...
      >
        &emsp;&emsp;&emsp;Кроме того, в седмицу совершается, как правило, 4 богослужения (иногда 6). Если в течение
        седмицы случается двунадесятый праздник, великий праздник, а так же праздник чтимой иконы Пресвятой Богородицы
        или же чтимого святого, богослужение совершается среди седмицы, аще нет, богослужение правится в пятницу вечером
        (зачастую это либо шестеричная, либо славословная, реже без знака или полиелейная служба). Ориентиром служит
        книга Богослужебные указания на текущий год и предпочтение отдаётся службам с наиболее высоким знакам, а так же
        русским святым.
      </Text>
      <Break stepMobile={12} stepTablet={14} stepLaptop={18} stepDesktop={22} top />
      <Text
        ...
        textAling={EAling.justify}
      >
        &emsp;&emsp;&emsp;Первую и последнюю седмицы Великого поста уставные богослужения совершаются ежедневно.
        Полиелейные службы, а так же обязательно отправляется служба св. Марии Египетской и Суббота Акафиста. На первой
        и последней седмице, а так же на Мариином стоянии читается канон св. Андрея Критского. На Светлой седмице
        богослужения совершаются с воскресенья вечера (Великая вечерня) до Светлой среды (Литургия) В эти дни
        обязательно совершается Крестный ход вокруг храма. Следующее богослужение совершается на Светлой седмицы в
        пятницу.
      </Text>
    </div>
  );
