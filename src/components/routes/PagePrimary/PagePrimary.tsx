  ...
  return (
    <div className={styles.pagePrimary}>
      ...
      >
        ...
        воскресные и праздничные дни. Возглашаются проповеди, проводятся встречи с учителями и учениками. Каждый четверг
        в 9:00 служится акафист святителю Николаю.
      </Text>
      <Text
        As='p'
        fontMobile={{ size: 14, lineHeight: '18px', weight: 400 }}
